...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <ul class="columns">
        ...
        <li>
            <asp:LinkButton runat="server" OnClick="DownloadButton_Click">Скачать словарь</asp:LinkButton>, 735K
        </li> 
        <li>
            <asp:LinkButton runat="server" OnClick="DownloadButton2_Click">Скачать словарь словоформ</asp:LinkButton>, 7М
        </li>
    </ul>
    
    <p> Формат словаря &mdash; текстовый файл в кодировке Windows-1251 в архиве ZIP. 
    ...
    <p>
        Что отличает ODict.ru от других вариантов словаря Зализняка?
        Почему вам стоит выбрать его для вашего следующего NLP-проекта?
    </p>
    
    <ul>
        <li> Возможность пополнения: 
            ваша программа, основанная на словаре ODict.ru, 
            со временем будет только улучшаться и вам для этого ничего не нужно делать.
            Если вы заметите, что какого-то слова нет в словаре, его очень легко добавить.  
            Для этого не нужно спрашивать ничьего разрешения.
        </li>
        <li>
            <p> Наличие информации об ударениях. Как известно, все мы родом из Зализняка, но многие словари в процессе своего развития утратили целые пласты информации, 
            ...
            <ul>
                <li>информация об ударении, основном и побочном, о случаях переноса ударения на частицу или предлог;</li>
                <li>информация о видовых парах, о распределении глагольного вида по глагольным формам;</li>
                <li>информация об отсутствующих и "затрудненных" грамматических формах;</li>
            </ul>
    
            <p>oDict, напротив, эту информацию сохранил и преумножил &mdash; в новых статьях. Кроме того, были добавлены (не для всех статей): </p>
    
            <ul>
                <li>связи между прилагательными на -ский (-цкий) и мотивирующими словами;</li>
                <li>пометы, определяющие выбор предлога В или НА в локативе;</li>
            </ul>

        </li>
    </ul>
    
    <h2> Знакомство со словарем </h2>

    <pre style="float: left; margin-right: 2em; margin-top: 2em; clear: both;">лемматизация 9 ж 7а
