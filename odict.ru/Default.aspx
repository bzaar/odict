...
реабилитационный 12 п 1*а</pre>
    ...
    <p> Большая часть словаря является одним из ранних изданий словаря Зализняка,
        ...
        Добавлено более 3000 новых слов, из них немалую часть составляют топонимы.
    ...
    <p> Топонимы на <b>-ино, -цыно, -ово, -ево, -ёво</b> даны в словаре в классическом склоняемом варианте: <b><code>Бородино 8 с 1в</code></b>.
    ...
    <h2>Программы на основе «Открытого словаря» </h2>

    <ul>
        <li><a href='https://chrome.google.com/webstore/detail/russiangram/bidcnmfhffpamjhgkemdmjdmnchjnmdf'>Программа расстановки ударений на веб-страницах (плагин для Chrome)</a></li>
        <li><a href='http://morpher.ru'>Программа склонения по падежам слов и словосочетаний «Морфер»</a></li>
    </ul>
